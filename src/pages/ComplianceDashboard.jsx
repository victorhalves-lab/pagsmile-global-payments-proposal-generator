...
import { Copy, CheckCircle, ExternalLink, ShieldCheck, FileText, ClipboardList } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-white/50 mt-1">Manage KYC questionnaires and compliance documentation</p>
      </div>

      <Tabs defaultValue="form" className="w-full">
        <TabsList className="bg-white/5 border border-white/10 p-1 rounded-xl">
          <TabsTrigger value="form" className="data-[state=active]:bg-[#2bc196] data-[state=active]:text-[#002443] text-white/60 rounded-lg px-6">
            <FileText className="h-4 w-4 mr-2" />
            Compliance Questionnaire
          </TabsTrigger>
          <TabsTrigger value="received" className="data-[state=active]:bg-[#2bc196] data-[state=active]:text-[#002443] text-white/60 rounded-lg px-6">
